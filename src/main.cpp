...
static constexpr uint32_t print_debug_us = 50;
static constexpr uint32_t print_period_us = 1000000UL / print_debug_us;
...
void loop() 
{
  ...
  if ((now - last_next_print_time_us) > print_period_us) {
